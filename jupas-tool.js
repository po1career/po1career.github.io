...
const STRINGS = {
  en: {
    ...
    link: 'Official page ↗',
    duration: 'Duration',
    footer: 'Unofficial reference tool for PLK No.1 students — not affiliated with JUPAS. Data may be incomplete or out of date; always verify on the official JUPAS website (www.jupas.edu.hk) and the institution\'s website before applying.',
  ...
  zh: {
    ...
    link: '官方網頁 ↗',
    duration: '修業年期',
    footer: '本工具只供本校學生參考，並非 JUPAS 官方工具。資料可能不完整或過時，報讀前請於 JUPAS 官方網站（www.jupas.edu.hk）及院校網站核實。',
