...
(function () {
  ...
  function renderStatic() {
    ...
    var navTx = lang === "zh"
      ? { news: "最新消息", res: "實用連結", studytools: "學習工具", jupastools: "JUPAS 工具", quiz: "興趣測驗", pathways: "升學出路", pomodoro: "番茄鐘", studyplan: "溫習計劃", dse: "DSE 試卷組合", streaming: "選科工具", jupas: "JUPAS 搜尋器", jupaschoices: "JUPAS 選科" }
      : { news: "Latest News", res: "Useful Links", studytools: "Study Tools", jupastools: "JUPAS Tools", quiz: "Career Quiz", pathways: "Pathways Explorer", pomodoro: "Pomodoro", studyplan: "Study Plan", dse: "DSE Portfolio", streaming: "Streaming Tool", jupas: "JUPAS Finder", jupaschoices: "JUPAS Choices" };
    ["news", "res", "studytools", "jupastools", "quiz", "pathways", "pomodoro", "studyplan", "dse", "streaming", "jupas", "jupaschoices"].forEach(function (k) { var el = $("nav-" + k); if (el) el.textContent = navTx[k]; });
