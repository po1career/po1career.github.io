...
(function () {
  ...
  function renderStatic() {
    ...
    var navTx = lang === "zh"
      ? { news: "最新消息", res: "資源下載", pomodoro: "番茄鐘", studyplan: "溫習計劃", dse: "DSE 試卷組合", jupas: "JUPAS 搜尋器" }
      : { news: "Latest News", res: "Resources", pomodoro: "Pomodoro", studyplan: "Study Plan", dse: "DSE Portfolio", jupas: "JUPAS Finder" };
    ["news", "res", "pomodoro", "studyplan", "dse", "jupas"].forEach(function (k) { var el = $("nav-" + k); if (el) el.textContent = navTx[k]; });
