...
(function () {
  ...
  var TYPES = [
    ...
    { k: "I", c: "#3a7ca5",
      ...
      subjects: { en: "Physics · Chemistry · Biology · M1/M2 · ICT · Economics",
                  zh: "物理．化學．生物．數學單元一／二．資訊及通訊科技．經濟" } },
    { k: "A", c: "#9a5ba6",
  ...
  var T = {
    en: {
      ...
      nav_quiz: "Career Quiz", nav_pomodoro: "Pomodoro", nav_studyplan: "Study Plan", nav_dse: "DSE Portfolio",
    ...
    zh: {
      ...
      nav_quiz: "興趣測驗", nav_pomodoro: "番茄鐘", nav_studyplan: "溫習計劃", nav_dse: "DSE 試卷組合",
  ...
  function applyChrome() {
    ...
    setText("nav-quiz", t("nav_quiz")); setText("nav-pomodoro", t("nav_pomodoro"));
