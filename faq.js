...
(function () {
  ...
  var GLOSSARY = [
    ...
    { abbr: "M1 / M2", term: { en: "Maths Extended Modules", zh: "數學延伸單元" },
      def: { en: "Optional extra maths — M1 (Statistics) or M2 (Algebra & Calculus). Many science/engineering/business degrees value or require it.",
             zh: "額外的數學單元——M1（統計）或 M2（代數與微積分）。不少理工及商科學位重視或要求修讀。" } },
    { abbr: "3322", term: { en: "3322 (+2)", zh: "3322（+2）" },
      def: { en: "The usual minimum for a JUPAS degree: Level 3 in Chinese & English, Level 2 in Maths and CSD/Liberal Studies, plus Level 2–3 in two electives.",
             zh: "入讀聯招學位的一般最低要求：中、英達第 3 級，數學及公民與社會發展（前通識）達第 2 級，另加兩科選修科達第 2–3 級。" } },
  ...
  var FAQS = [
    ...
    { cat: "subjects",
      q: { en: "Should I take M1 or M2?", zh: "我應修讀 M1 還是 M2 嗎？" },
      a: { en: "M1 (Statistics) or M2 (Algebra & Calculus) is worth considering if you enjoy maths and are aiming at science, engineering, computing, business or economics — many such degrees value or require it. It is extra work, so take it only if your maths is solid.",
           zh: "若你喜歡數學，並有意升讀理科、工程、計算機、商科或經濟，值得考慮修讀 M1（統計）或 M2（代數與微積分）——不少相關學位重視或要求修讀。但這是額外課業，數學根基穩固才宜修讀。" } },
    { cat: "grades",
      q: { en: "What does “3322” mean?", zh: "「3322」是甚麼意思？" },
      a: { en: "It's the usual minimum to be considered for a JUPAS degree: Level 3 in Chinese and English, Level 2 in Maths and in CSD (formerly Liberal Studies), plus the programme's own elective requirements. Competitive programmes ask for much more than the minimum.",
           zh: "這是被聯招學位考慮的一般最低要求：中、英達第 3 級，數學及公民與社會發展（前通識）達第 2 級，再加課程本身的選修科要求。熱門課程的實際收生遠高於此最低標準。" } },
    { cat: "grades",
    ...
    { cat: "jupas",
      ...
      a: { en: "JUPAS is the main system for applying to government-funded bachelor's degrees with your DSE results. You register and set your choices in F.6 (around late autumn), refine them before results, then accept an offer in the summer. Your Career teacher will guide you through each step.",
           zh: "聯招是以文憑試成績報讀政府資助學士課程的主要系統。你會在中六（約秋季後段）登記及設定志願，放榜前再調整，暑假時接受取錄。升學輔導老師會逐步指導你。" } },
    { cat: "jupas",
      q: { en: "How many programmes can I choose, and does the order matter?", zh: "可以選多少個課程？次序重要嗎？" },
      a: { en: "You may list up to 20 programmes in order of genuine preference. Your top 3 (Band A) carry the most weight, so put your real first choices there — never order by “safety”. Use the <a href=\"jupas-tool.html\">JUPAS Finder</a> to explore programmes.",
           zh: "你最多可按真實意願排列 20 個課程。首 3 個（甲組）權重最大，請把真正首選放在這裡，切勿以「保險」來排序。可用 <a href=\"jupas-tool.html\">JUPAS 搜尋器</a>探索課程。" } },
    { cat: "jupas",
    ...
    { cat: "after",
      ...
      a: { en: "Yes — there are set windows to add, drop and reorder your choices, including an important chance to amend after the DSE results are released. Watch the official dates and check your choices with your Career teacher before each deadline.",
           zh: "可以——系統設有指定時段供你新增、刪除及重新排序志願，包括放榜後一個重要的修改機會。請留意官方日期，並在每個限期前與升學輔導老師檢視你的志願。" } },
    { cat: "general",
