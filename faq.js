...
(function () {
  ...
  var FAQS = [
    ...
    { cat: "subjects",
      q: { en: "Should I take M2?", zh: "我應修讀 M2 嗎？" },
      a: { en: "M2 (Algebra & Calculus) — the Maths Extended Module offered at our school — is worth considering if you enjoy maths and are aiming at science, engineering, computing, business or economics, since many such degrees value or require it. It is extra work, so take it only if your maths is solid.",
           zh: "M2（代數與微積分）是本校開設的數學延伸單元。若你喜歡數學，並有意升讀理科、工程、計算機、商科或經濟，值得考慮修讀，因為不少相關學位重視或要求修讀。但這是額外課業，數學根基穩固才宜修讀。" } },
    { cat: "grades",
    ...
    { cat: "jupas",
      ...
      a: { en: "JUPAS is the main system for applying to government-funded bachelor's degrees with your DSE results. You register and set your choices in F.6 around November–December, refine them before the exam, then accept an offer in July–August after results. Your Career teacher will guide you through each step.",
           zh: "聯招是以文憑試成績報讀政府資助學士課程的主要系統。你會在中六約十一月至十二月登記及設定志願，考試前再調整，放榜後於七至八月接受取錄。升學輔導老師會逐步指導你。" } },
    { cat: "jupas",
