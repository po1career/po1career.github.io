...
(function () {
  ...
  var PATHWAYS = [
    { id: "jupas", icon: "🎓", c: "#2f6db0", c2: "#57a0db",
      ...
      entry: { en: "Usually the “3322” minimum (Chinese, English, Maths, Citizenship & Social Development) plus electives; each programme sets its own subject requirements.",
               zh: "一般須達「3322」最低要求（中、英、數、公民與社會發展）並符合課程指定的選修科要求。" },
